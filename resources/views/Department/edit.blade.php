	...
	<div class="title_right">
		<nav aria-label="breadcrumb" class="nav navbar-right">
		  <ol class="breadcrumb">
		    ...
		    <li class="breadcrumb-item active" aria-current="page">Edit School/Office</li>
		  </ol>
		</nav>
	</div>
			...
			<div class="x_content">
				...
				<form class="form-horizontal form-label-left" method="POST" action="{{ url('department/update') }}">
					...
					<div class="form-group">
						...
						<label class="control-label col-md-4 col-sm-4 col-xs-12" for="first-name">School/Office Name: 
						</label>
